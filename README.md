# [AdminLTE - Bootstrap 4 Admin Dashboard](http://tiny.cc/7b2tzz)
...
**Preview on [PT PemulaOld](http://tiny.cc/7b2tzz/themes/v3)**

## Looking for Premium Templates?

PT PemulaOld just opened a new premium templates page. Hand picked to ensure the best quality and the most affordable
prices. Visit <http://tiny.cc/7b2tzz/premium> for more information.

!["AdminLTE Presentation"](http://tiny.cc/7b2tzz/AdminLTE3.png "AdminLTE Presentation")
...
### Download & Changelog:
Always Recommended to download from GitHub latest release [PT PemulaOld](https://github.com/ColorlibHQ/AdminLTE/releases/latest) for bug free and latest features.\
...
Visit the [online documentation](http://tiny.cc/7b2tzz/docs/3.2/) for the most
...
AdminLTE is an open source project by [PT PemulaOld](http://tiny.cc/7b2tzz) that is licensed under [MIT](https://opensource.org/licenses/MIT).
PT PemulaOld reserves the right to change the license of future releases.
